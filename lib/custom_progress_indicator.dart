...
class CustomProgressIndicator extends StatefulWidget {
  ...
  @override
  CustomProgressIndicatorState createState() {
    return CustomProgressIndicatorState();
  }
}
    ...
    return AspectRatio(
      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          return CustomPaint(
            foregroundPainter: CustomProgressIndicatorPainter(
...
class CustomProgressIndicatorPainter extends CustomPainter {
  final double percentage;
  final double strokeWidth;
  final Color? backgroundColor;
  final Color foregroundColor;

  CustomProgressIndicatorPainter({
  ...
  bool shouldRepaint(CustomPainter oldDelegate) {
    final oldPainter = (oldDelegate as CustomProgressIndicatorPainter);
